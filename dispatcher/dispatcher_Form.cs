...
{
    public partial class dispatcher_Form : UIForm
    {
        ...
        */
        ...
        private void tasks_display()
        {
            ...
            set_view(uiDataGridView1 ,tasks1);
            set_view(uiDataGridView2, tasks2);
            tabControl1.Refresh();
        ...
        private void set_view(UIDataGridView view, IQueryable<task> task)
        {
            int i = 0;
        ...
        private ArrayList get_selected_tasks_bike_id(UIDataGridView view)
        {
        ...
        {
            ArrayList selected_id = get_selected_tasks_bike_id(uiDataGridView1);
        ...
        {
            ArrayList selected_id = get_selected_tasks_bike_id(uiDataGridView2);
            if (selected_id.Count == 0)
            {
                MessageBox.Show("请先选择任务！"); return;//未选择数据
            }
