...
namespace shareBike
{
    partial class CustomerForm
    {
        ...
        int bias_x = 15;//绘图需要的X偏移
        int bias_y = 40;//绘图需要的Y偏移
        Graphics g = null;
        SolidBrush mysbrush1 = null;
        SolidBrush mysbrush2 = null;
        #endregion
